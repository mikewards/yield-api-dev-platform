...
import com.tbd.model.YieldAccounts
...
class YieldService {
    ...
    private val marketService = com.tbd.service.MorphoMarketService()
    ...
    fun deposit(accountId: UUID, yieldAccountId: UUID, request: DepositRequest): TransactionResponse {
        return transaction {
            ...
            // Create transaction
            val now = java.time.Instant.now()
            val transactionId = com.tbd.model.Transactions.insert {
                it[com.tbd.model.Transactions.accountId] = accountId
                it[com.tbd.model.Transactions.yieldAccountId] = yieldAccountId
                it[com.tbd.model.Transactions.type] = "deposit"
                it[com.tbd.model.Transactions.status] = "pending"
                it[com.tbd.model.Transactions.amount] = amount
                it[com.tbd.model.Transactions.currency] = request.currency
                it[com.tbd.model.Transactions.sourceAddress] = request.source_address
                it[com.tbd.model.Transactions.createdAt] = now
            } get com.tbd.model.Transactions.id
            ...
            com.tbd.model.Transactions.update({ com.tbd.model.Transactions.id eq transactionId }) {
                it[com.tbd.model.Transactions.status] = "completed"
                it[com.tbd.model.Transactions.completedAt] = java.time.Instant.now()
            }
            ...
            TransactionResponse(
                ...
                status = "completed",
                created_at = com.tbd.model.Transactions.select { 
                    com.tbd.model.Transactions.id eq transactionId 
                }.first()[com.tbd.model.Transactions.createdAt]?.toString() ?: now.toString()
            )
        }
    }
    ...
    fun withdraw(accountId: UUID, yieldAccountId: UUID, request: WithdrawRequest): TransactionResponse {
        return transaction {
            ...
            val transactionId = com.tbd.model.Transactions.insert {
                it[com.tbd.model.Transactions.accountId] = accountId
                it[com.tbd.model.Transactions.yieldAccountId] = yieldAccountId
                it[com.tbd.model.Transactions.type] = "withdraw"
                it[com.tbd.model.Transactions.status] = "pending"
                it[com.tbd.model.Transactions.amount] = amount
                it[com.tbd.model.Transactions.currency] = request.currency
                it[com.tbd.model.Transactions.destinationAddress] = request.destination_address
                it[com.tbd.model.Transactions.createdAt] = now
            } get com.tbd.model.Transactions.id
